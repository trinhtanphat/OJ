...
urlpatterns = [
    ...
    path('api/cppro/admin/badges/<str:identifier>/assignments/<str:user_identifier>', cppro_api.cppro_badge_assignments),
    path('api/cppro/admin/badges/<str:identifier>/assignments', cppro_api.cppro_badge_assignments),
    path('api/cppro/admin/badges/<str:identifier>', cppro_api.cppro_admin_management, {'section': 'badges'}),
    path('api/cppro/admin/badges', cppro_api.cppro_admin_management, {'section': 'badges'}),
    path('api/cppro/admin/users/<str:identifier>', cppro_api.cppro_admin_management, {'section': 'users'}),
    path('api/cppro/admin/users', cppro_api.cppro_admin_management, {'section': 'users'}),
